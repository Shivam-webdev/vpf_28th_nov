...
const candidateSchema = new mongoose.Schema({
  ...
  currentStage: {
    type: String,
    enum: ['Career Enquiry', 'Resume Shortlisted', 'Interview Process', 'Selected', 'Joining Data'],
    default: 'Career Enquiry'
  },
  currentStatus: {
    type: String,
    enum: ['Career Enquiry', 'Resume Shortlisted', 'Interview Process', 'Joining Data', 'Rejected'],
    default: 'Career Enquiry'
  },
